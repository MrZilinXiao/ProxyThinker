...
class CudaPlatformBase(Platform):
    ...
    def check_and_update_config(cls, vllm_config: VllmConfig) -> None:
        ...
        if parallel_config.worker_cls == "auto":
            ...
            elif vllm_config.contrastive_decoding_config:
                if envs.VLLM_USE_V1:
                    # parallel_config.worker_cls = \
                    #         "vllm.v1.worker.gpu_worker.Worker"
                    raise NotImplementedError("Contrastive decoding is not supported on V1 engine.")
                else:
                    parallel_config.worker_cls = \
                        "vllm.contrast_decode.contrast_decode_worker.create_contrastive_worker" 
