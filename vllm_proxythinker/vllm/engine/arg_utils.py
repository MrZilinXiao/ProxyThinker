...
from vllm.config import (CacheConfig, CompilationConfig, ConfigFormat,
                         ...
                         TokenizerPoolConfig, VllmConfig, ContrastiveDecodingConfig)
...
class EngineArgs:
    ...
    cd_tensor_parallel_size: Optional[int] = None  # smaller models could use smaller tp_size
    cd_put_on_diff_gpus: Optional[bool] = None
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parser.add_argument('--cd-tensor-parallel-size', 
                            type=int, 
                            default=None, 
                            help='Number of tensor parallel replicas for the contrastive decoding model.')
        parser.add_argument('--cd-put-on-diff-gpus',
                            action=StoreBoolean,
                            default=True, 
                            help='If set to True, the positive and negative models for contrastive decoding will be put on different GPUs. ')
    ...
    def create_engine_config(
        ...
        contrastive_decoding_config = ContrastiveDecodingConfig.maybe_create_cd_config(
            ...
            cd_tensor_parallel_size=self.cd_tensor_parallel_size,
            cd_put_on_diff_gpus=self.cd_put_on_diff_gpus,
        )
