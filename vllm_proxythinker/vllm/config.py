...
class ContrastiveDecodingConfig:
    ...
    def maybe_create_cd_config(
        ...
        cd_tensor_parallel_size: Optional[int],
        cd_put_on_diff_gpus: bool,
        ...
        # hacking the tensor parallel size for contrastive decoding
        if cd_tensor_parallel_size is not None:
            contrastive_parallel_config = ParallelConfig(
                pipeline_parallel_size=base_parallel_config.
                pipeline_parallel_size,
                tensor_parallel_size=cd_tensor_parallel_size,
                distributed_executor_backend=base_parallel_config.
                distributed_executor_backend,
                max_parallel_loading_workers=base_parallel_config.
                max_parallel_loading_workers,
                disable_custom_all_reduce=base_parallel_config.
                disable_custom_all_reduce,
                tokenizer_pool_config=base_parallel_config.tokenizer_pool_config,
                ray_workers_use_nsight=base_parallel_config.
                ray_workers_use_nsight,
                placement_group=base_parallel_config.placement_group,
            )
...
class VllmConfig:
    ...
    def __str__(self):
        return (
            ...
            f" contrastive_decoding_config={self.contrastive_decoding_config!r},"
