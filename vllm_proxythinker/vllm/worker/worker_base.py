...
class LocalOrDistributedWorkerBase(WorkerBase):
    ...
    def _get_worker_input_from_broadcast(
        ...
        broadcast_data = broadcast_tensor_dict(src=0)  # this should receive from local tp group!
    ...
    def execute_model(
        ...
        # base worker will also trigger this
        # logger.info(f"inputs: completed at rank: {get_tp_group().rank} rank_in_group: {get_tp_group().rank_in_group}")
        ...
        # logger.info(f"before model_runner.execute_model completed at rank: {get_tp_group().rank} rank_in_group: {get_tp_group().rank_in_group}")
