...
class MultiStepModelRunner(GPUModelRunnerBase[StatefulModelInput]):
    ...
    def execute_model(
        ...
        # logger.info(
        #     f"MultiStepModelRunner at {get_tp_group().rank} {self._base_model_runner.is_driver_worker}: len of output: {len(output)} output: {output} "
        # )
...
def _pythonize_sampler_output(
    ...
    for sgdx, (seq_group,
        ...
        # TODO: remove this assertion -- in positive model we only need 
        # the logits to work
